      ...
      <div className="content-card">
        ...
        <section style={{ paddingTop: "140px", paddingBottom: "32px" }}>
          <div className="cuen-container">
            <div className="section-label fade-up" style={{ marginBottom: "16px" }}>Service</div>
          ...
          <div className="cuen-container">
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              {services.map((service, i) => (
                <div key={service.num} className={`fade-up fade-up-delay-${(i % 3) + 1}`} style={{ background: "#ffffff", borderRadius: "16px", padding: "24px 20px", boxShadow: "0 2px 16px rgba(0,0,0,0.06)", border: "none", transition: "transform 0.2s ease, box-shadow 0.2s ease" }}
        ...
        <section style={{ padding: "48px 0", background: "var(--cuen-offwhite)" }}>
          <div className="cuen-container">
            <div className="fade-up" style={{ marginBottom: "32px" }}>
              <div className="section-label" style={{ marginBottom: "16px" }}>Approach</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "12px" }}>
              {steps.map((step, i) => (
                <div key={step.num} className={`fade-up fade-up-delay-${i + 1}`} style={{ background: "#ffffff", borderRadius: "16px", padding: "24px 20px", boxShadow: "0 2px 16px rgba(0,0,0,0.06)", border: "none", transition: "transform 0.2s ease, box-shadow 0.2s ease" }}
                  onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.transform = "translateY(-4px)"; (e.currentTarget as HTMLElement).style.boxShadow = "0 8px 32px rgba(0,0,0,0.10)"; }}
                  onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLElement).style.boxShadow = "0 2px 16px rgba(0,0,0,0.06)"; }}
                >
