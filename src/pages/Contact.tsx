      ...
      <div className="content-card">
        ...
        <section style={{ paddingTop: "160px", paddingBottom: "80px" }}>
          <div className="cuen-container">
            ...
            <h1 className="fade-up fade-up-delay-1" style={{ fontFamily: "'Space Grotesk', 'Zen Kaku Gothic New', sans-serif", fontSize: "clamp(32px, 8vw, 48px)", fontWeight: 700, color: "var(--cuen-charcoal)", margin: "0 0 24px 0", lineHeight: 1.25 }}>まずは、現状のモヤモヤをお聞かせください。</h1>
            ...
            <div style={{ maxWidth: "640px" }}>
              {submitted ? (
                <div className="fade-up" style={{ padding: "64px 0", textAlign: "center" }}>
                  ...
                  <h2 style={{ fontFamily: "'Space Grotesk', 'Zen Kaku Gothic New', sans-serif", fontSize: "28px", fontWeight: 700, color: "var(--cuen-charcoal)", margin: "0 0 16px 0" }}>ありがとうございます。</h2>
                  <p style={{ fontSize: "16px", color: "#666", lineHeight: 1.85 }}>
                ...
                <form onSubmit={handleSubmit} className="fade-up fade-up-delay-1">
                  <div style={{ display: "flex", flexDirection: "column", gap: "40px" }}>
                    <div>
                      <label style={{ fontFamily: "'Space Grotesk', monospace", fontSize: "11px", letterSpacing: "0.12em", color: "#9E9B95", textTransform: "uppercase", display: "block", marginBottom: "8px" }}>お名前 <span style={{ color: "#006875" }}>*</span></label>
                      <input type="text" name="name" value={formData.name} onChange={handleChange} required placeholder="山田 太郎" className="cuen-input" />
                    </div>
                    <div>
                      <label style={{ fontFamily: "'Space Grotesk', monospace", fontSize: "11px", letterSpacing: "0.12em", color: "#9E9B95", textTransform: "uppercase", display: "block", marginBottom: "8px" }}>会社名</label>
                      <input type="text" name="company" value={formData.company} onChange={handleChange} placeholder="株式会社〇〇" className="cuen-input" />
                    </div>
                    <div>
                      <label style={{ fontFamily: "'Space Grotesk', monospace", fontSize: "11px", letterSpacing: "0.12em", color: "#9E9B95", textTransform: "uppercase", display: "block", marginBottom: "8px" }}>メールアドレス <span style={{ color: "#006875" }}>*</span></label>
                    ...
                    <div>
                      <label style={{ fontFamily: "'Space Grotesk', monospace", fontSize: "11px", letterSpacing: "0.12em", color: "#9E9B95", textTransform: "uppercase", display: "block", marginBottom: "8px" }}>お問い合わせ種別</label>
                    ...
                    <div>
                      <label style={{ fontFamily: "'Space Grotesk', monospace", fontSize: "11px", letterSpacing: "0.12em", color: "#9E9B95", textTransform: "uppercase", display: "block", marginBottom: "8px" }}>メッセージ <span style={{ color: "#006875" }}>*</span></label>
